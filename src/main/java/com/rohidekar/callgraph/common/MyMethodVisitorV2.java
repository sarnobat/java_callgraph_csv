...
class MyMethodVisitorV2 extends MethodVisitor {
  private final JavaClass visitedClass;
  private final ConstantPoolGen constantsPool;
  private final RelationshipsV2 relationships;
  private final String parentMethodQualifiedName;

  MyMethodVisitorV2(MethodGen methodGen, JavaClass javaClass, RelationshipsV2 relationships) {
  ...
  public static MyInstruction getInstruction(JavaClass parentClassOrInterface,
      String unqualifiedChildMethodName, RelationshipsV2 relationships) {
